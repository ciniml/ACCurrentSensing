...
using ACCurrentSensing.View;
using Microsoft.WindowsAzure.MobileServices;

// The Blank Application template is documented at http://go.microsoft.com/fwlink/?LinkId=402347&clcid=0x409

namespace ACCurrentSensing
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        public CurrentSensorDeviceWatcher DeviceWatcher { get; private set; }
        public PowerDistribution PowerDistribution { get; private set; }
        public PowerDistributionLogger PowerDistributionLogger { get; private set; }

        public SensorRegistry SensorRegistry { get; private set; }
        ...
        public void SaveSensorRegistry()
        {
            var serialized = this.SensorRegistry.Serialize();
            Windows.Storage.ApplicationData.Current.LocalSettings.Values["SensorRegistry"] = serialized;
        }
